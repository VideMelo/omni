                  ...
                  <div className="flex flex-col gap-2 w-full">
                     <div className="flex gap-1 p-4 w-full bg-black animate-pulse bg-opacity-40 hover:bg-opacity-50 rounded-2xl cursor-pointer">
                        <div className="flex w-full gap-4">
                           <div
                              className={`h-[135px] w-[135px] shrink-0 animate-pulse bg-white bg-opacity-5 rounded-md`}
                           />
                     ...
                     {[1, 2, 3].map((i) => (
                        ...
                        >
                           ...
                           <div className="flex flex-col gap-1">
                              ...
                              <div className="font-normal h-3 w-20 animate-pulse bg-white bg-opacity-5">
                                 {' '}
                              </div>
                           </div>
                        </div>
            ...
            <div className="flex flex-col w-full gap-3">
                     ...
                     <div className="flex gap-1 p-4 w-full bg-black bg-opacity-40 hover:bg-opacity-50 rounded-2xl cursor-pointer">
                        <div className="flex w-full gap-4">
                           ...
                           <div className="flex flex-col py-1 w-full">
                              ...
                              {top.type === 'artist' ? (
                                 <div className="font-poppins font-normal text-base text-[#B3B3B3] capitalize">
                                    {top.type}
                                 </div>
                              ) : (
               ...
               <div className="flex flex-col w-full">
                  {tracks.slice(0, 3).map(({ name, artist, thumbnail, id }: any) => (
                     <div
                        key={id}
                        className="flex items-center gap-3 cursor-pointer hover:bg-white hover:bg-opacity-5 p-1 rounded-md"
                     >
