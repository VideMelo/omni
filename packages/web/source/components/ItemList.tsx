               ...
               >
                  <ul className="flex gap-1 mt-2 scrollbar-none flex-grow">
                     {[1, 2, 3, 4, 5, 6].map((i) => (
                        <li
                           key={i}
                           className="flex flex-col gap-1 first:ml-6 last:mr-6 p-4 rounded-md"
                        >
                           <div
                  ...
                  {data.map((item: any, index: number) => (
                     ...
                     >
                        <div className="group flex flex-col items-end">
                           ...
                           {item.type == 'track' ? (
                              <button
                                 ...
                                 onClick={(event) =>
                                    newTrack? newTrack(event, data[index]) : null
                                 }
                              >
                        ...
                        <div className="flex mt-2 flex-col w-[140px]">
                           <div className="font-poppins font-medium text-base truncate">
                              {item.name}
                           </div>
